...
class SimpleDGCN(nn.Module):
    def __init__(self, nf=[], num_nodes=None, num_neighbors=None):
        super(SimpleDGCN, self).__init__()
        ...
        # Block cat
        self.mlp_cat = MLP([nf[0]+nf[1]+nf[2], 1], num_nodes)
        ...
        print('SimpleDGCN num_nodes, num_neighbors, num_edges',  self.num_nodes, self.num_neighbors, self.num_edges)
    ...
    def forward(self, x, edge_index):
        ...
        # print('edge_index',  edge_index.size(), self.num_nodes, self.num_neighbors, self.num_edges)
